...
class Visual:
    ...
    def __init__(self):
        ...
        self.title_menu_text = self.tmt_font.render(cst.TMT, True, cst.BLUE)
        self.ctp_font = pygame.font.Font(cst.Bold_text_font, 20)
        self.click_to_play = self.ctp_font.render(cst.CTP, True, cst.BLUE)
        self.inv_font = pygame.font.Font(cst.Bold_text_font, 20)
        self.inventory = self.inv_font.render(cst.INVENTORY, True, cst.BLUE)
        ...
        self.vic_text_1 = self.vic_font_1.render(cst.VICTORY_1, True, cst.BLUE)
        self.vic_font_2 = pygame.font.Font(cst.Bold_text_font, 30)
        self.vic_text_2 = self.vic_font_2.render(cst.VICTORY_2, True, cst.BLUE)
